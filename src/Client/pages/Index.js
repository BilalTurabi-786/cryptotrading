  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-6 col-md-6 col-sm-12 mt-5">
        ...
        <h2>Read All Reviews From Densik Fans</h2>
    ...
    <div className="row mt-5">
      <div className="col-lg-12 col-md-12 col-sm-12">
        <div className="div dark rounded">
      ...
      <div className="container">
        ...
        <div className="row mt-5">
          <div className="col-lg-4 col-md-4 col-sm-12">
            ...
            <p className="text-white mt-3">It's crafted with the latest trend of &amp; coded with modern approaches</p>
          </div>
